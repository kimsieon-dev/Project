...
<body>
	<nav>
		<div class="dropmenu">
			<ul>
				...
				<li id="login"><%=id.equals("") ? "<a href='memberLogin.bd'>로그인</a>" : "<a href='memberLogoutAction.bd'>로그아웃</a>"%>
				</li>

				<li id="login2"><%=id.equals("") ? "<a href='memberJoin.bd'>회원 가입</a>" : "<a href='memberDetail.bd'>회원 정보 변경</a>"%>
				</li>
			</ul>
		</div>
	...
	<section>
		<div class="page">
			<div class="page1">
				<img src="image/home_icon.png"> <span>></span> <a href="#">선수단</a>
				<span>></span> <a href="#">불펜</a>
			</div>
	...
	<section>
		<div class="main">
			<img src=image/ChoiJigwang1.jpg />
		</div>

		<div class="maintitle">
			<p>
				NO.40&nbsp;<strong>최지광</strong>
			</p>
		</div>
