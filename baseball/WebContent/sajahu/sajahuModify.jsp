				...
				<div id="content">
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="sajahu_title" class="int" value="<%=article.getSajahu_title() %>" />
						</span>
					...
					<div>
						...
						<span class="box2 int_id"> <textarea id="sajahu_content"
								name="sajahu_content" class="int"
								style="height: 379px; resize: none;"><%=article.getSajahu_content() %></textarea>
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
