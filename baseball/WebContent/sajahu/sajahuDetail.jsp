...
<link rel="stylesheet" href="css/sajahuDetail.css" />
...
<body>
	...
	<section>
		...
		<tbody>
			<tr>
				<td><%=article.getSajahu_title() %></td>
				<td><%=article.getSajahu_id() %></td>
				<td><%=article.getSajahu_readcount() %></td>
				<td><%=article.getSajahu_date() %></td>
		...
		<article>
			<pre><%=article.getSajahu_content() %></pre>
		</article>
		
	</section>
	
	<section id="commandList">
	<a href="sajahuList.bd?page=<%=nowPage %>">[목록] </a> 
	<%
		if(article.getSajahu_id() != null && article.getSajahu_id().equals(session.getAttribute("id"))) {
	%>
		<a href="sajahuDelete.bd?sajahu_no=<%=article.getSajahu_no() %>&page=<%=nowPage %>">[삭제] </a>
		<a href="sajahuModifyForm.bd?sajahu_no=<%=article.getSajahu_no() %>&page=<%=nowPage %>">[수정] </a>
	<%
		}
	%>
	</section>
