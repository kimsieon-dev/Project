				...
				<div id="content">
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_title" class="int" value="<%=article.getLineup_title() %>" />
						</span>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="lineup_vs" name="lineup_vs" class="int" value="<%=article.getLineup_vs() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_pit" class="int" value="<%=article.getLineup_pit() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_bat1" class="int" value="<%=article.getLineup_bat1() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_bat2" class="int" value="<%=article.getLineup_bat2() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_bat3" class="int" value="<%=article.getLineup_bat3() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_bat4" class="int" value="<%=article.getLineup_bat4() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_bat5" class="int" value="<%=article.getLineup_bat5() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_bat6" class="int" value="<%=article.getLineup_bat6() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_bat7" class="int" value="<%=article.getLineup_bat7() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_bat8" class="int" value="<%=article.getLineup_bat8() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
					...
					<div>
						...
						<span class="box int_id"> <input type="text"
							id="notice_title" name="lineup_bat9" class="int" value="<%=article.getLineup_bat9() %>" />
						</span>
						<div class="check_font" id="id_check"></div>
						<span class="error_next_box"></span>
					</div>
